        ...
        <div class="card-body p-1 lg:p-2 xl:p-3">
          ...
          <div>
            <div class="flex items-center gap-3">
              ...
              <h2 class="font-normal text-xl text-[#131313B3]">Breed: 
                <span class="text-lg">${
            ...
            <div class="flex items-center gap-3">
              ...
              <h2 class="font-normal text-xl text-[#131313B3]">Birth: 
                <span class="text-lg">${
            ...
            <div class="flex items-center gap-3">
              ...
              <h2 class="font-normal text-xl text-[#131313B3]">Gender: 
                <span class="text-lg">${
            ...
            <div class="flex items-center gap-3">
              ...
              <h2 class="font-normal text-xl text-[#131313B3]">Price: 
  ...
  const content = `
      ...
      <div class="">
        ...
        <div class="">
          ...
          <div class="flex items-center gap-3">
              <img src="../images/price.png" alt="" class="w-6 h-6">
              <h2 class="font-normal text-xl text-[#131313B3]">Price: <span class="text-lg price">$${
                petData.price ? petData.price : "Not Available"
              }</span></h2>
          </div>
          <div class="flex items-center gap-3">
              <img src="../images/vaccinated.png" alt="" class="w-6 h-6">
              <h2 class="font-normal text-xl text-[#131313B3]">Vaccinated Status: <span class="text-lg">${
